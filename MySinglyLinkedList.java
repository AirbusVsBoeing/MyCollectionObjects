...
public class MySinglyLinkedList<E> implements List<E> {
	...
	public Object[] toArray() {
		...
		Node<E> current = head;
		while(current!=null) {
			toReturn[counter] = current.element;
			++counter;
			current = current.next;
		}
	...
	public MySinglyLinkedListIterator<E> mySinglyLinkedListIterator() {
		return this.new MySinglyLinkedListIterator<E>();
	}
	
	public MySinglyLinkedList outer() {
		return this;
	}
	...
	public class MySinglyLinkedListIterator<E> implements Iterator<E>{
		
		Node<E> current;
		
		public MySinglyLinkedListIterator() {
			current = outer().head;
		}
